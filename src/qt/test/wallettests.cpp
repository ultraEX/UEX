...
//
//     src/qt/test/test_uex-qt -platform xcb      # Linux
//     src/qt/test/test_uex-qt -platform windows  # Windows
//     src/qt/test/test_uex-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: UEX:")) != -1);
