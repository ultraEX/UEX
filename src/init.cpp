 ...
 * between uexd, and uex-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ultraEX/UEX>";
    const std::string URL_WEBSITE = "<https://ultraEX.io>";
