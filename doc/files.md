...
* bitcoin.conf: contains configuration settings for uexd or uex-qt
* uexd.pid: stores the process id of uexd while running
...
* debug.log: contains debug information and general logging generated by uexd or uex-qt
