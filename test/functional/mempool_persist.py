...
By default, uexd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give uexd a second to reload the mempool
        ...
        self.log.debug("Prevent uexd from writing mempool.dat to disk. Verify that `savemempool` fails")
